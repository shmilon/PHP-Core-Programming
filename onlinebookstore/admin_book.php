					...
					<?php while ($row = mysqli_fetch_assoc($result)) { ?>
						<tr>
							<td class="px-2 py-1 align-middle">
								<a href="book.php?bookisbn=<?php echo $row['book_isbn']; ?>" target="_blank"><img
										width="60px" src="./bootstrap/img/<?php echo $row['book_image']; ?>" /></a>
							</td>
							...
							<td class="px-2 py-1 align-middle text-center">
								<div class="btn-group btn-group-sm">
									...
									<a href="admin_delete.php?bookisbn=<?php echo $row['book_isbn']; ?>"
										class="btn btn-sm rounded-0 btn-danger" title="Delete"
